package br.com.ultracodeultracodejpa.security;
...
public class UserSS implements UserDetails {
	...
	public UserSS(Integer id, String email, String password, Set<RolesEnum> perfis) {
		super();
		this.id = id;
		this.email = email;
	...
	public boolean hasRole(RolesEnum perfil) {
